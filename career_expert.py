...
class CareerExpertSystem(KnowledgeEngine):
    ...
    @Rule(StudentFacts(likes='Programming'), StudentFacts(likes='AI Concept'))
    def AIML(self):
        print("Suggested Career Path: AIML Engineering")
...
def main():
    ...
    interests = input("Enter your interests separated by commas (e.g., Maths, Physics, Programming, Biology, Chemistry, Circuits, Statistics, AI Concept): ").split(',')
